...
- Dispute initiation is visible *before* purchase, not buried after it. Knowing recourse exists is
...
and it went fine but felt risky. Shops on the *chapa* home from work — one hand, standing, bad
signal in tunnels.
