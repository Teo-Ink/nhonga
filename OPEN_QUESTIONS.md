...
more than raw bandwidth, and a European region adds ~120ms to _every_ request — which compounds
...
KYB submission, signed merchant agreement, issued _Short Code_ / merchant number, then API
...
Mozambique's IVA rate and marketplace-facilitator obligations — specifically, whether _you_ or
each _vendor_ is the party liable to remit IVA on a marketplace sale — determine whether tax is
...
_Raised in Phase 2. This is now the highest-consequence open question in the project._
...
_Raised in Phase 3 while writing the COD provider._
